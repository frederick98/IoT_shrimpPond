...
const Dashboard = () => {
  ...
  return (
    <>
        ...
        <CCardBody className="mb-4 align-items-center mt-3">
          <CRow>
            ...
            <CCol>
              <CWidgetDropdown
                color="gradient-primary"
                header="Pond Monitoring"
                text="Monitor your Pond using available Sensor Node"
                footerSlot={
                  <CWidgetProgressIcon
                    header="2"
                    text="Sensor Node currently in Monitoring"
                    color="gradient-info"
                    inverse
                  >
                    <CIcon name="cil-monitor" height="36" />
                  </CWidgetProgressIcon>
                }
              >
                <CDropdown>
          ...
          <CRow>
            <CCol>
              <CWidgetDropdown
                color="gradient-primary"
                header="How-To-Use"
                text="Helps you understand how to setup and use this application"
                footerSlot={
                  <CWidgetProgressIcon
                    header="4"
                    text="Steps"
      ...
      <CCard>
        <CCardHeader>About Applications</CCardHeader>
        <CCardBody className="mb-4 align-items-center mt-3">
          <CRow>
            <CCol>
              <CWidgetDropdown
                ...
                text="Take a look at features from this application, who knows you can use more features available here."
                footerSlot={
                  <CWidgetProgressIcon
                    header="5"
                    text="Total Features"
            ...
            <CCol>
              <CWidgetDropdown
                ...
                text="Knowing all hardwares used by this application is the good way to start."
                footerSlot={
                  <CWidgetProgressIcon
                    header="7"
                    text="Hardware Used"
                    ...
                    inverse
                  >
                    <CIcon name="cil-devices" height="36" />
                  </CWidgetProgressIcon>
                }
              >
                <CDropdown>
            ...
            <CCol>
              <CWidgetDropdown
                color="gradient-primary"
                header="Authors of This Application"
                text="Got some problem? Got any issues with the applications? Feel free to contact us."
                footerSlot={
                  <CWidgetProgressIcon
                    header="3"
