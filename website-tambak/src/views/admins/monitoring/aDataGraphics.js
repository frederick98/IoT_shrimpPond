    ...
    <>
      <CCard>
        <CCardBody>
          <CRow>
            <CCol sm="5">
              <h4 id="nodeArduino" className="card-title mb-0">
                Arduino Node "n"
              </h4>
              <div className="small text-muted">"Date Time Now"</div>
            </CCol>
        ...
        <CCardFooter>
          <CRow className="text-center">
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">Temperature Sensor</div>
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0 d-md-down-none">
              <div className="text-muted">Turbidity Sensor</div>
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0">
              <div className="text-muted">pH Sensor</div>
            ...
            <CCol md sm="12" className="mb-sm-2 mb-0 d-md-down-none">
              <div className="text-muted">Dissolved Oxygen Sensor</div>
